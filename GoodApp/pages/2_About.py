...
with col2:
    st.markdown("""
        #### Privacybeleid
        Bij HealthyLife staat uw privacy centraal. We slaan geen gegevens op; elke voorspelling is uniek voor uw sessie en wordt automatisch verwijderd. Uw privacy is onze belofte.
